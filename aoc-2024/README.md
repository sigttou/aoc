...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `80.0µs` | `148.0µs` |
| [Day 2](./src/bin/02.rs) | `193.7µs` | `343.2µs` |
| [Day 3](./src/bin/03.rs) | `444.1µs` | `476.5µs` |
| [Day 4](./src/bin/04.rs) | `275.7µs` | `114.9µs` |
| [Day 5](./src/bin/05.rs) | `203.7µs` | `342.0µs` |
| [Day 6](./src/bin/06.rs) | `352.9µs` | `1.4s` |
| [Day 7](./src/bin/07.rs) | `1.3ms` | `47.9ms` |
| [Day 8](./src/bin/08.rs) | `60.3µs` | `129.8µs` |
| [Day 9](./src/bin/09.rs) | `412.6µs` | `40.9ms` |
| [Day 10](./src/bin/10.rs) | `543.6µs` | `516.5µs` |
| [Day 11](./src/bin/11.rs) | `144.8µs` | `6.6ms` |
| [Day 12](./src/bin/12.rs) | `4.1ms` | `5.7ms` |
| [Day 13](./src/bin/13.rs) | `152.0µs` | `154.8µs` |
| [Day 14](./src/bin/14.rs) | `461.3µs` | `149.2ms` |
| [Day 15](./src/bin/15.rs) | `885.1µs` | `2.0ms` |
| [Day 16](./src/bin/16.rs) | `207.1ms` | `201.8ms` |
| [Day 17](./src/bin/17.rs) | `2.1µs` | `201.3µs` |
| [Day 18](./src/bin/18.rs) | `871.5µs` | `5.1ms` |
| [Day 19](./src/bin/19.rs) | `15.2ms` | `43.8ms` |
| [Day 20](./src/bin/20.rs) | `2.7ms` | `294.0ms` |
| [Day 21](./src/bin/21.rs) | `509.0ns` | `513.0ns` |
| [Day 22](./src/bin/22.rs) | `22.4ms` | `347.6ms` |
| [Day 23](./src/bin/23.rs) | `16.7ms` | `3.3ms` |
| [Day 24](./src/bin/24.rs) | `187.2µs` | `5.0µs` |
| [Day 25](./src/bin/25.rs) | `2.9ms` | `33.0ns` |
